...
def getSensorsJSON(weatherShield, verbose=False):
...
if __name__ == "__main__":
	...
	while(1):
		time.sleep(1)
		client.publishEvent('piweathershield', 'json', getSensorsJSON(weatherShield, verbose) , qos=0)
